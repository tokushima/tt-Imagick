...
class Calc{
	 ...
	 * サイズ width, height (px)
	 */
	public static function get_size_px(string $type, float $dpi=72): array{
	 ...
	 * サイズ width, height (pt)
	 */
	public static function get_size_pt(string $type): array{
		[$w, $h] = self::get_size_mm($type);
	 ...
	 * サイズ width, height (mm)
	 */
	public static function get_size_mm(string $type): array{
